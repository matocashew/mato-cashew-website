const en = {
  ...
  retail: {
    ...
    items: {
      ...
      pack100: {
        title: "Premium Cashew 100g",
        badge: "Snack Pack",
      },

      pack250: {
        title: "Premium Cashew 250g",
        badge: "Family Pack",
      },

      pack500: {
        title: "Premium Cashew 500g",
        badge: "Best Seller",
      },
  ...
  wholesale: {
    ...
    title: "Bulk Packaging for International Buyers",

    items: {
      vacuum10kg: {
        title: "10kg Vacuum Pack",

        description:
          "Premium whole white kernels packed in food-grade vacuum bags for maximum freshness.",
      ...
      exportCarton: {
        title: "22.68kg Export Carton (50 lbs)",

        description:
          "Designed for international distributors and food manufacturers requiring large-volume supply.",
...
resources: {
  ...
  listing: {
    ...
    pageDescription:
      "Expert guides, buying advice, export insights, and educational resources about Cambodian cashews.",

    heroTitle: "Resources",

    heroDescription:
      "Expert guides, buying advice, export insights, and educational resources from Mato Cashew.",
