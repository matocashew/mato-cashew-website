...
Kernel form should therefore be selected according to the intended presentation or processing requirement&mdash;not as a simple best-to-worst ranking.
...
**Lower count per unit weight &rarr; generally larger individual whole kernels**

**Higher count per unit weight &rarr; generally smaller individual whole kernels**
...
1. **Define the intended application** &mdash; determine the end use and presentation need.
2. **Select kernel form** &mdash; whole, butt, split, or piece.
3. **Select the size requirement** &mdash; whole-kernel count or specified piece-size category.
4. **Define the quality class** &mdash; colour, defects, tolerances, and applicable quality terminology.
5. **Define technical requirements** &mdash; moisture, food safety, and other buyer specifications.
6. **Consider process performance** &mdash; including performance after roasting or further processing where relevant.
7. **Select packaging** &mdash; according to product protection and commercial needs.
8. **Confirm buyer and market requirements** &mdash; including any applicable market-specific requirements.
9. **Agree the commercial specification** &mdash; ensure both seller and buyer use the same definitions and acceptance criteria.
