...
**Raw cashew nut &rarr; conditioning or steaming &rarr; shelling &rarr; kernel drying &rarr; finished cashew kernel**
...
The **AFI Specifications for Cashew Kernels**, adopted in September 2023, state that the moisture level of cashews shall be **3&ndash;5%**.

AFI also identifies recognized loss-on-drying approaches for determining moisture, including a moisture-balance method at 105&deg;C, AACCI Method 44-15 (modified), or an equivalent method that correlates with the referenced AOAC method or equivalent vacuum-oven method.

### UNECE DDP-17

**UNECE DDP-17 &mdash; Cashew Kernels (2023)** is a commercial and marketing quality standard for cashew kernels. It sets a **maximum moisture content of 5.0%**.
